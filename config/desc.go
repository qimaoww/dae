...
var SectionSummaryDesc = Desc{
	...
	"dns":          "See more at https://github.com/qimaoww/dae/blob/main/docs/en/configuration/dns.md.",
	"group":        "Node group. Groups defined here can be used as outbounds in section \"routing\".",
	"routing": `Traffic follows this routing. See https://github.com/qimaoww/dae/blob/main/docs/en/configuration/routing.md for full examples.
...
4. "domain++". Based on domain+ mode but force to re-route traffic using sniffed domain to partially recover domain based traffic split ability. It doesn't work for direct traffic and consumes more CPU resources.`,
	...
	"auto_config_kernel_parameter": "Automatically configure Linux kernel parameters like ip_forward and send_redirects. Check out https://github.com/qimaoww/dae/blob/main/docs/en/user-guide/kernel-parameters.md to see what will dae do.",
	...
	"utls_imitate":                 "The Client Hello ID for uTLS to imitate. This takes effect only if tls_implementation is utls. See more: https://github.com/qimaoww/dae/blob/331fa23c16/component/outbound/transport/tls/utls.go#L17",
