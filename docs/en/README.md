...
See [daeuniverse/dae-installer](https://github.com/qimaoww/dae-installer) (or [mirror](https://hubmirror.v2raya.org/daeuniverse/dae-installer)).
...
# See https://github.com/qimaoww/dae/blob/main/docs/en/configuration/dns.md for full examples.
dns {
  upstream {
...
# See https://github.com/qimaoww/dae/blob/main/docs/en/configuration/routing.md for full examples.
routing {
...
See more at [example.dae](https://github.com/qimaoww/dae/blob/main/example.dae).

If you use PVE, refer to [#37](https://github.com/qimaoww/dae/discussions/37).
