...
```bash
mkdir -p /etc/dae
curl -L -o /etc/dae/config.dae https://github.com/qimaoww/dae/raw/main/example.dae
chmod 600 /etc/dae/config.dae
```

## Download pre-compiled binaries

Releases are available in <https://github.com/qimaoww/dae/releases>
...
Nightly builds are available in <https://github.com/qimaoww/dae/actions/workflows/build-nightly.yml>
...
sudo curl -L -o /etc/systemd/system/dae.service https://github.com/qimaoww/dae/raw/main/install/dae.service
